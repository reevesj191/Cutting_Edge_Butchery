...
```{r fig3, fig.cap="Cumulative frequencies of archaeological types according to selection stage. (1) Produced but not considered. (2) Set aside for further consideration. (3) Selected for use during the butchery task. (4) Used during butchery tasks. \\label{CE_f2}"}
