...
dat <- list(
  ...
  EA = xdata$mean_angle_deg, # Average edge angles
  C = xdata$Per_Cortex
)
...
ceM1 <- ulam(
  ...
  ), data= dat, chains = 4, cores =4, iter = 10000, cmdstan = TRUE
  )
...
```{r write model}
saveRDS(ceM1, file = "Models/CE_Global_Model_4.RDS")
```
